...
<html>
  ...
  <div style="margin-top: 10px;">
  	<form class="form-horizontal" action="${pageContext.request.contextPath }/client/RegisterServlet" method="post">
    	...
    	<div class="form-group"><label class="col-sm-2 col-sm-offset-3 control-label">QQ账号：</label><div class="col-sm-3"><input type="text" class="form-control" name="email"></div></div>
